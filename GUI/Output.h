...
public:
	...
	void CreateDesignToolBar(bool  select = true) const;	//Tool bar of the design mode
	void CreateSimulationToolBar(bool select = true) const;   //Tool bar of the simulation mode
	void CreateStatusBar() const;	//Create Status bar
	void DrawString(int x, int y, string label) const;
